		...
		<>
			<section
				...
				<div class='text'>
					...
					<p>
						...
						restaurants with customers seamlessly. Based in Maiduguri, Nigeria, Foodbyt
						charges no commission fees to restaurants!
					</p>
					<div>
						<a href=''>
			...
			<section class='mission'>
				<div class='text'>
					...
					<p>
						...
						team with big dreams, determined to create a food ordering platform that
				...
				<div class='sub-sec'>
					<div>
						...
						<p>
							To become the leading food delivery platform in Maiduguri, empowering
							local restaurants and delighting customers with exceptional service.
						</p>
					</div>
					<div>
						<h5>
					...
					<div class='sub-sec'>
						<div>
							...
							<p>
								...
								prompt, and the food arrived fresh and delicious. highly recommend!"
							</p>
						</div>
					</div>
				</div>
			...
			<section class='contact pop-up'>
				<div class='text'>
					...
					<h2>Let's Connect</h2>
					<p>
						We're excited to connect with you. we're here to answer your questions and
